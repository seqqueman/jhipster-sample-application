...
public class FeatureResourceIT {
    ...
    public static Feature createEntity(EntityManager em) {
        ...
        feature.setAdvertisment(advertisment);
        return feature;
    }
    /**
    ...
    public void createFeature() throws Exception {
        ...
        assertThat(testFeature.getId()).isEqualTo(testFeature.getAdvertisment().getId());
    }
    ...
    @Test
    @Transactional
    public void updateFeatureMapsIdAssociationWithNewId() throws Exception {
        ...
        updatedFeature.setAdvertisment(advertisment);
