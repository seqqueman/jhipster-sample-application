...
import com.mycompany.myapp.repository.UserRegisteredRepository;
...
public class UserRegisteredResourceIT {
    ...
    public void createUserRegistered() throws Exception {
        ...
        restUserRegisteredMockMvc.perform(post("/api/user-registereds")
        ...
        assertThat(testUserRegistered.getUsername()).isEqualTo(DEFAULT_USERNAME);
    ...
    public void updateUserRegisteredMapsIdAssociationWithNewId() throws Exception {
        ...
        // Update the entity
        restUserRegisteredMockMvc.perform(put("/api/user-registereds")
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void checkUsernameIsRequired() throws Exception {
        int databaseSizeBeforeTest = userRegisteredRepository.findAll().size();
        // set the field null
        userRegistered.setUsername(null);

        // Create the UserRegistered, which fails.
        ...
        List<UserRegistered> userRegisteredList = userRegisteredRepository.findAll();
        assertThat(userRegisteredList).hasSize(databaseSizeBeforeTest);
    }
    ...
    public void getAllUserRegistereds() throws Exception {
        ...
        restUserRegisteredMockMvc.perform(get("/api/user-registereds?sort=id,desc"))
            .andExpect(status().isOk())
    ...
    public void getUserRegistered() throws Exception {
        ...
        restUserRegisteredMockMvc.perform(get("/api/user-registereds/{id}", userRegistered.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getNonExistingUserRegistered() throws Exception {
        // Get the userRegistered
        restUserRegisteredMockMvc.perform(get("/api/user-registereds/{id}", Long.MAX_VALUE))
    ...
    public void updateUserRegistered() throws Exception {
        ...
        UserRegistered testUserRegistered = userRegisteredList.get(userRegisteredList.size() - 1);
        assertThat(testUserRegistered.getUsername()).isEqualTo(UPDATED_USERNAME);
    ...
    public void deleteUserRegistered() throws Exception {
        ...
        restUserRegisteredMockMvc.perform(delete("/api/user-registereds/{id}", userRegistered.getId())
