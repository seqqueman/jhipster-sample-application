...
export class AdvertismentComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.advertismentService
      ...
      .subscribe(
        (res: HttpResponse<IAdvertisment[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IAdvertisment[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
