...
public class AddressResource {
    ...
    public AddressResource(AddressRepository addressRepository, AdvertismentRepository advertismentRepository) {
    ...
    public ResponseEntity<Address> createAddress(@Valid @RequestBody Address address) throws URISyntaxException {
        ...
        if (Objects.isNull(address.getAdvertisment())) {
            throw new BadRequestAlertException("Invalid association value provided", ENTITY_NAME, "null");
        }
        Long advertismentId = address.getAdvertisment().getId();
        advertismentRepository.findById(advertismentId).ifPresent(address::advertisment);
