...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.UserRegistered}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class UserRegisteredResource {
    ...
    public ResponseEntity<UserRegistered> createUserRegistered(@Valid @RequestBody UserRegistered userRegistered) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/user-registereds/" + result.getId()))
    ...
    public ResponseEntity<UserRegistered> updateUserRegistered(@Valid @RequestBody UserRegistered userRegistered) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, userRegistered.getId().toString()))
            .body(result);
    }
